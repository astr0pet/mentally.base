...
function showBlur() {
    $.post('https://mt-inventory/showBlur');
}
...
//     localStorage.setItem('mt-inventory-color', color);
// }

// const savedColor = localStorage.getItem('mt-inventory-color');
...
function FormatAttachmentInfo(data) {
    $.post(
        "https://mt-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://mt-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://mt-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://mt-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://mt-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://mt-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://mt-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                ...
                if (
                    ...
                    $.post(
                        "https://mt-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://mt-inventory/PlayDropFail", JSON.stringify({}));
}
...
(() => {
    ...
    Inventory.Close = function() {
        ...
        $.post("https://mt-inventory/CloseInventory", JSON.stringify({}));
