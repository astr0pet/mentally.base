...
RegisterNUICallback('showBlur', function()
    Wait(50)
    TriggerEvent("mt-inventory:client:showBlur")
end) 
RegisterNetEvent("mt-inventory:client:showBlur", function()
    Wait(50)
...
RegisterNetEvent("mt-inventory:client:closeinv", function()
    closeInventory()
end)
...
RegisterNetEvent('mt-inventory:client:giveAnim', function()
