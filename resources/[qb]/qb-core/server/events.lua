...
RegisterNetEvent('QBCore:Server:UseItem', function(item)
    print(string.format('%s triggered QBCore:Server:UseItem by ID %s with the following data. This event is deprecated due to exploitation, and will be removed soon. Check mt-inventory for the right use on this event.', GetInvokingResource(), source))
    QBCore.Debug(item)
end)
...
-- https://github.com/qbcore-framework/mt-inventory/blob/e4ef156d93dd1727234d388c3f25110c350b3bcf/server/main.lua#L2066
--end)
