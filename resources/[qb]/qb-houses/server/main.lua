...
QBCore.Functions.CreateCallback('mt-phone:server:TransferCid', function(_, cb, NewCid, house)
...
QBCore.Functions.CreateCallback('mt-phone:server:GetPlayerHouses', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local MyHouses = {}
...
QBCore.Functions.CreateCallback('mt-phone:server:GetHouseKeys', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local MyKeys = {}
...
QBCore.Functions.CreateCallback('mt-phone:server:MeosGetPlayerHouses', function(_, cb, input)
    if input then
